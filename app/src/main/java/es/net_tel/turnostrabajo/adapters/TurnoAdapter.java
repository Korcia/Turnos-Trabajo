...
public class TurnoAdapter extends BaseAdapter {
    ...
    public TurnoAdapter(Context context, ArrayList<String> items) {
        mContexto = context;
        mDatos = items;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = mInflater.inflate(R.layout.turno_info, parent, false);

        TextView filaTextView = (TextView) rowView.findViewById(R.id.fila_turno);
